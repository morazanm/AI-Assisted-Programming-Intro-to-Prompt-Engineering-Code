...
def dist_origin(coord):
    """
    Define a function to compute the distance of a coordinate from the origin.
    The distance is computed as the square root of the sum of the squares of the coordinates.
    """
    if coord.is_2d():
