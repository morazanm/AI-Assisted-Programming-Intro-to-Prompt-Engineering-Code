...
def is_on_Dean_list2(a_student: Student) -> bool:
    """
...
"""
Define a test for is_on_Dean_list2
"""
def test_is_on_Dean_list2():
    """
    Signature: () -> None
    ...
    assert is_on_Dean_list2(student1) == True, "Test Case 0 Failed"
    assert is_on_Dean_list2(student2) == False, "Test Case 1 Failed"
    assert is_on_Dean_list2(student3) == True, "Test Case 2 Failed"
    assert is_on_Dean_list2(student4) == False, "Test Case 3 Failed"
    assert is_on_Dean_list2(student5) == True, "Test Case 4 Failed"
    assert is_on_Dean_list2(student6) == True, "Test Case 5 Failed"

test_is_on_Dean_list2()